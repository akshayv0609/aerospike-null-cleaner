 ...
 * This class runs both cleaners concurrently to improve performance.
 * It collects and displays the results after both cleaners have completed.
 */
public class App {
    /**
     * Main method that serves as the entry point for the application.
     * Creates and runs both cleaners in separate threads, then displays the results.
     * 
